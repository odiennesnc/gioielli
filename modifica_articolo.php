...
// Verifica se è stato specificato un ID dell'articolo
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $sql = "UPDATE articoli SET
            ...
            costo_lavorazione = :costo_lavorazione, 
            incassatura = :incassatura, 
            incisione = :incisione, 
            rodiatura_1 = :rodiatura_1, 
            rodiatura_2 = :rodiatura_2, 
            brillanti_1 = :brillanti_1, 
            brillanti_2 = :brillanti_2, 
            brillanti_3 = :brillanti_3, 
            brillanti_4 = :brillanti_4, 
            brillanti_5 = :brillanti_5, 
            grammi_oro = :grammi_oro, 
            costo_lavorazione_finale = :costo_lavorazione_finale, 
            incassatura_finale = :incassatura_finale, 
            incisione_finale = :incisione_finale, 
            rodiatura_1_finale = :rodiatura_1_finale, 
            rodiatura_2_finale = :rodiatura_2_finale, 
            brillanti_1_finale = :brillanti_1_finale, 
            brillanti_2_finale = :brillanti_2_finale, 
            brillanti_3_finale = :brillanti_3_finale, 
            brillanti_4_finale = :brillanti_4_finale, 
            brillanti_5_finale = :brillanti_5_finale, 
            grammi_oro_finale = :grammi_oro_finale, 
            stato = :stato
            WHERE id = :id";
        ...
        // Recupera l'articolo aggiornato
...
// Output della pagina
echo getHeader('Modifica articolo');
getSidebar('articoli');
?>
                ...
                <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
                    <div class="mb-6">
                        ...
                        <input 
                            ...
                            value="<?= htmlspecialchars($articolo['descrizione']) ?>"
                            required
                        />
                    </div>
                    ...
                    <div class="flex justify-between items-center mb-6">
                        ...
                        <div class="w-1/3">
                            ...
                            <select name="stato" class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                                <option value="magazzino" <?= $articolo['stato'] == 'magazzino' ? 'selected' : '' ?>>In magazzino</option>
                                <option value="venduto" <?= $articolo['stato'] == 'venduto' ? 'selected' : '' ?>>Venduto</option>
                            </select>
                        </div>
                    </div>
                        ...
                        <div>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['costo_lavorazione']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['incassatura']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['incisione']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['rodiatura_1']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['rodiatura_2']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['brillanti_1']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['brillanti_2']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['brillanti_3']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['brillanti_4']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['brillanti_5']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['grammi_oro']) ?>"
                                />
                            </label>
                        </div>
                        ...
                        <div>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['costo_lavorazione_finale']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['incassatura_finale']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['incisione_finale']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['rodiatura_1_finale']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['rodiatura_2_finale']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['brillanti_1_finale']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['brillanti_2_finale']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['brillanti_3_finale']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['brillanti_4_finale']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['brillanti_5_finale']) ?>"
                                />
                            </label>
                            ...
                            <label class="block text-sm mb-4">
                                ...
                                <input 
                                    ...
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" 
                                    placeholder="0.00"
                                    value="<?= htmlspecialchars($articolo['grammi_oro_finale']) ?>"
                                />
                            </label>
                        </div>
                    </div>
