...
// Query per ottenere gli articoli venduti
$stmt = $pdo->query("SELECT * FROM articoli WHERE stato = 'venduto' ORDER BY data_creazione DESC");
$articoli = $stmt->fetchAll();

// Output della pagina
echo getHeader('Articoli venduti');
getSidebar('articoli_venduti');
?>
                            ...
                            <?php foreach ($articoli as $articolo): ?>
                                <tr class="text-gray-700 dark:text-gray-400">
                                    ...
                                    <td class="px-4 py-3 text-xs">
                                        <span class="px-2 py-1 font-semibold leading-tight rounded-full text-gray-700 bg-gray-100 dark:bg-gray-700 dark:text-gray-100">
                                            Venduto
                                        </span>
                                    </td>
                                    <td class="px-4 py-3 text-sm">
                            ...
                            <?php if (empty($articoli)): ?>
                                <tr class="text-gray-700 dark:text-gray-400">
                                    <td colspan="8" class="px-4 py-3 text-sm text-center">
                                        Nessun articolo venduto presente.
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
